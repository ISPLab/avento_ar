...
namespace UnityEngine.XR.Templates.AR.Editor
{
    ...
    public class PanoramaSkyboxViewerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var mode = (PanoramaSkyboxViewer.ContentMode)m_ContentMode.enumValueIndex;
            ...
            EditorGUILayout.Slider(m_Opacity, 0f, 1f, new GUIContent("Opacity", "How solid the 360 dome is over the live camera. Default 50%."));
